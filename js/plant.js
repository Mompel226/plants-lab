...
window.PLANT = {
  ...
  parts: [
    ...
    { id: 'fruit',      label: 'Fruit and seeds', note: 'the ovary, after fertilisation',   colour: '#FFD27A', box: { x: 540, y: 160, w: 320, h: 260 } },
  ...
  stages: [
    ...
    { id: 'stem',      label: 'Stem',          show: ['seed', 'roots', 'stem', 'leaf-3', 'leaf-4'],   lit: ['stem'], flow: 'both' },
