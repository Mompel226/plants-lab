...
(function (global) {
  ...
  [
    ...
    /* seen from the side, with the seed coats still on: a seedling photographed from above is just a small plant */
    ['seedling', 'seedlings-pot-900.jpg', 'A <b>seedling</b>: a young plant, a few days after germination. In these sunflowers the seed coats are still stuck to the seed leaves, and each stem is still bent into a hook from pushing up through the compost. The white fuzz on the compost is a root, covered in root hairs.', 'From the 16.3 lesson slides'],
    ['seedlings', 'seedlings-pot-900.jpg', '<b>Seedlings</b>: young sunflowers, a few days after germination. The seed coats are still on the seed leaves, the stems are still hooked from pushing through the compost, and one root lies on the surface, white with root hairs.', 'From the 16.3 lesson slides'],
